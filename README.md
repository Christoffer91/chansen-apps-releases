...
[**Download Local Dictation 1.0.27**](https://github.com/Christoffer91/chansen-apps-releases/releases/download/dictation-v1.0.27/MacLocalDictation-1.0.27-1027.dmg)
...
[**Download Local Capture 1.0.27**](https://github.com/Christoffer91/chansen-apps-releases/releases/download/dictation-v1.0.27/MacLocalCapture-1.0.27-127.dmg)

</td>
</tr>
</table>

[All releases](https://github.com/Christoffer91/chansen-apps-releases/releases) · [Release notes and checksums](https://github.com/Christoffer91/chansen-apps-releases/releases/tag/dictation-v1.0.27)
...
The download links above point to the published **1.0.27** release.
